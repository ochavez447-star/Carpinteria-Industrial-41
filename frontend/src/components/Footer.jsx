...
const Footer = () => {
    return (
        <footer className="bg-brand-dark border-t border-brand-accent/20 pt-12 pb-6 text-brand-light">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <p className="text-sm text-brand-light/60 mb-6 max-w-xs">
                        ...
                        <a
                            ...
                            className="flex items-center gap-2 text-brand-light/80 hover:text-brand-accent transition-colors border border-brand-accent/30 rounded-full px-4 py-2 hover:bg-brand-accent/10"
                        >
                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <ul className="space-y-4 text-sm text-brand-light/80">
                            <li className="flex items-center gap-3 justify-center md:justify-start">
                                ...
                                <a href="https://wa.me/5585814258" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                                    55-8581-4258
                                </a>
                            </li>
                            <li className="flex items-center gap-3 justify-center md:justify-start">
                                <FiPhone className="text-brand-accent text-lg flex-shrink-0" />
                                <a href="tel:5585814258" className="hover:text-white transition-colors">
                                    55-8581-4258
                                </a>
                            </li>
                            <li className="flex items-center gap-3 justify-center md:justify-start">
                                <FiMail className="text-brand-accent text-lg flex-shrink-0" />
                                <a href="mailto:contacto@madera-precisa.com" className="hover:text-white transition-colors">
                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <div className="flex gap-3 justify-center md:justify-start text-sm text-brand-light/80">
                ...
                {/* Copyright */}
                <div className="border-t border-brand-accent/10 pt-6 text-center text-xs text-brand-light/40">
